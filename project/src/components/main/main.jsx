          ...
          <div className="about__description">
            <div className="about__text">
              ...
              <p>Здравствуйте! Решил сменить профессию. Закончил курсы HTML Academy по профессии React-разработчик.
                Опыта коммерческой разработки пока что нет, только учебные проекты и проекты перед стажировкой. Освоил навыки адаптивной верстки, HTML, CSS, JS, React, Redux.
                Также сделал собственный Desktop ToDoList на реакте. Мой гитхаб: https://github.com/Mollycodd1e/</p>
            </div>
